...
export const SITES: SiteDescriptor[] = [
  ...
  { id: "claude", product: "Claude", wave: "A", origins: ["https://claude.ai/*"], selectors: ["[contenteditable='true'].ProseMirror", "div[contenteditable='true'][data-placeholder]"], verificationStatus: "pendingVerification", verificationNote: pending },
