...
const userVerified = "User-reported full real-site acceptance on 2026-08-09.";

export const SITES: SiteDescriptor[] = [
  { id: "chatgpt", product: "ChatGPT", wave: "A", origins: ["https://chatgpt.com/*"], selectors: ["#prompt-textarea", "textarea[data-testid='prompt-textarea']", "[contenteditable='true'][data-lexical-editor='true']"], overlayAnchorSelector: "form[data-type='unified-composer']", verificationStatus: "verified", lastVerifiedVersion: "0.1.0", verificationNote: userVerified },
  { id: "gemini", product: "Gemini", wave: "A", origins: ["https://gemini.google.com/*"], selectors: [".ql-editor[contenteditable='true'][role='textbox']", "rich-textarea [contenteditable='true'][role='textbox']"], minEditorHeight: 20, overlayAnchorSelector: "[data-node-type='input-area']", verificationStatus: "verified", lastVerifiedVersion: "0.1.0", verificationNote: userVerified },
  { id: "claude", product: "Claude", wave: "A", origins: ["https://claude.ai/*"], selectors: ["[data-testid='chat-input'][contenteditable='true']", "[contenteditable='true'].ProseMirror"], minEditorHeight: 20, overlayAnchorSelector: "fieldset", verificationStatus: "verified", lastVerifiedVersion: "0.1.0", verificationNote: userVerified },
