...
作为 2026-08-14 的历史快照，Blink 0.1.0 已达到本地 Beta 包的安装、首次使用、本地升级模拟、Reset、卸载和重装门槛；当时完整发布门槛仍受剩余实站矩阵、外部站点阻塞以及 Anthropic/Gemini 原生协议凭据验证影响。当前 Core Beta 范围与 0.1.1 证据以 [状态文档](./STATUS.md) 为准。
